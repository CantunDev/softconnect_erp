...
@section('content')
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8">
                            <div class="row text-center">
                                ...
                                <div class="col-xl-3">
                                    <div class="col">
                                        <img src="{{ Auth::user()->business->first()->business_file ?? 'https://avatar.oxro.io/avatar.svg?name=' . urlencode(Auth::user()->business->first()->business_name) }}" alt="" class="avatar-md rounded-circle d-block mx-auto">
    ...
    <div class="row">
        <div class="col-xl-4">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Sin informacion</h4>
