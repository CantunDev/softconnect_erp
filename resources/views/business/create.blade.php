...
@section('content')
    ...
    <form action="{{ route('config.business.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input name="web" type="url"
                                    class="form-control @error('web') is-invalid @enderror" id="inputWeb"
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group colorpicker-component">
                                    <input class="form-control form-control-color w-100" type="color"
                                        value="{{ old('color_primary', '#556ee6') }}" id="color_primary"
                                        name="color_primary">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group colorpicker-component">
                                    <input class="form-control form-control-color w-100" type="color"
                                        value="{{ old('color_secondary', '#34c38f') }}" id="color_secondary"
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group colorpicker-component">
                                    <input class="form-control form-control-color w-100" type="color"
                                        value="{{ old('color_accent', '#f1b44c') }}" id="color_accent"
                                        name="color_accent">
                                </div>
                            </div>
                        </div>
