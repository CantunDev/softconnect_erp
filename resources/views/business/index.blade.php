    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-end mb-3">
                <a href="{{ route('config.business.create') }}" class="btn btn-success d-flex align-items-center gap-1">
    ...
    <script>
        $(document).ready(function() {
            $('#table_business').DataTable({
                ...
                paging: true,
                ajax: {
                    url: '{!! route('config.business.index') !!}',
                },
                language: {
        ...
        function btnSuspend(id) {
            Swal.fire({
                ...
                if (e.value === true) {
                    $.ajax({
                        type: 'PUT',
                        url: "{{ url('config/suspend/business') }}/" + id,
                        data: {
                            id: id,
                            _token: '{!! csrf_token() !!}'
                        },
        ...
        function btnRestore(id) {
            Swal.fire({
                ...
                if (e.value === true) {
                    $.ajax({
                        type: 'PUT',
                        url: "{{ url('config/restore/business') }}/" + id,
                        data: {
                            id: id,
                            _token: '{!! csrf_token() !!}'
                        },
