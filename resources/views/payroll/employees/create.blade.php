                        ...
                        <form method="POST" action="" id="employeeForm">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                @endforeach --}}
                                                    ...
                                                    <!-- Puestos operativos básicos -->
                                                    <option value="lavaloza">Lavaloza</option>
                                                    <option value="ayudante_cocina">Ayudante de cocina</option>
                                                    <option value="ayudante_barra">Ayudante de barra</option>
                                                    <option value="runner">Runner / Auxiliar de servicio</option>
                                                    ...
                                                    <!-- Cocina -->
                                                    <option value="cocinero_a">Cocinero A</option>
                                                    <option value="cocinero_b">Cocinero B</option>
                                                    <option value="cocinero_c">Cocinero C</option>
                                                    <option value="encargado_turno_cocina">Encargado de turno (Cocina)
                                                    </option>
                                                    <option value="chef_partida">Chef de partida</option>
                                                    ...
                                                    <option value="jefe_barra">Jefe de barra</option>

                                                    <!-- Piso / Operación -->
                                                    <option value="capitan_meseros">Capitán de meseros</option>
                                                    <option value="encargado_turno">Encargado de turno</option>
                                                    <option value="supervisor">Supervisor</option>

                                                    <!-- Administración -->
                                                    <option value="aux_admin">Auxiliar administrativo</option>
                                                    <option value="compras">Compras / Almacén</option>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control @error('employment_type') is-invalid @enderror"
                                                    ...
                                                    <option value="fixed"
                                                        {{ old('employment_type', 'fixed') == 'fixed' ? 'selected' : '' }}>
                                                        Fijo
                                                    </option>
                                                    <option value="temporal"
                                                        {{ old('employment_type') == 'temporal' ? 'selected' : '' }}>
                                                        Temporal
                                                    </option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="card">
                                        <div class="card-header bg-light">
                                            <h6 class="mb-0"><i class="fas fa-file-invoice-dollar"></i> Datos Fiscales
                                            </h6>
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    <div class="card">
                                        <div class="card-header bg-light">
                                            <h6 class="mb-0"><i class="fas fa-sticky-note"></i> Información Adicional
                                            </h6>
                                        </div>
                                        <div class="card-body">
                                            <div class="mb-3">
